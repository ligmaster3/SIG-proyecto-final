                ...
                <ul class="navbar-nav flex-row gap-3">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            <li><a class="dropdown-item" href="logout.php" aria-label="Cerrar sesión"><i
                                        class="bi bi-box-arrow-right me-2" aria-hidden="true"></i> Cerrar sesión</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button"
                            ...
                            <img src="<?= htmlspecialchars($foto_estudiante ?: '../src/assets/img/user-default.png'); ?>"
                                ...
                                alt="Foto de perfil de <?= htmlspecialchars($_SESSION['user_name']) ?>"
                                style="object-fit: cover;" onerror="this.src='../src/assets/img/user-default.png';">
